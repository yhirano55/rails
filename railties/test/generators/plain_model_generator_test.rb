...
require "rails/generators/rails/plain_model/plain_model_generator"

class PlainModelGeneratorTest < Rails::Generators::TestCase
  include GeneratorsTestHelper

  def test_help_shows_invoked_generators_options
    content = run_generator ["--help"]
    assert_match(/Stubs out a new model as Plain Old Ruby Object/, content)
    assert_match(/rails generate plain_model address/, content)
  end
